...
```bash
cp $(which just) .agents/skills/just/scripts/just
...
mv just .agents/skills/just/scripts/just
chmod +x .agents/skills/just/scripts/just
```

### Option 3: Build from source
```bash
cargo install just --root .agents/skills/just/scripts
mv .agents/skills/just/scripts/bin/just .agents/skills/just/scripts/just
rmdir .agents/skills/just/scripts/bin
```
